...
import { Grid, Card, CardContent, Typography, Container, useMediaQuery, Theme, Stack, Avatar } from '@mui/material';
	...
	return (
		<Container maxWidth={false} className={smallScreen || collapsed ? 'page-container-smallscreen' : 'page-container'} >
			...
			{channels?.length === 0 && typeof window !== 'undefined'
				? <EmptyList type='channel' title='No Channels available' body='Create new channel to get started.' />
