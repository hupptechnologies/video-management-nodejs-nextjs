...
export const generateJWTToken = (detail: TTokenDetail) =>
...
export const generateRefreshToken = (detail: TTokenDetail) =>
	new Promise((resolve, reject) => {
		try {
...
export const verifyRefreshToken = (req: FastifyRequest, res: FastifyReply) => {
